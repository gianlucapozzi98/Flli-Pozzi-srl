    ...
    <>
      ...
      <main className="pt-20">
        ...
        <section className="py-20" style={{ paddingTop: '120px', paddingBottom: '80px' }}>
          <div className="px-0 lg:px-8" style={{ maxWidth: '1200px', margin: '0 auto' }}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              <motion.div
                ...
                className="aspect-[550/709] bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl overflow-hidden relative shadow-xl mx-auto lg:mx-0 w-[calc(100%-32px)] lg:w-full max-w-none"
              >
                <Image
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.6 }}
                className="text-lg text-text-light leading-relaxed text-center lg:text-left mx-auto lg:mx-0 w-[calc(100%-32px)] lg:w-full max-w-none px-0 lg:px-0"
        ...
        <section className="bg-bg-light" style={{ paddingTop: '65px', paddingBottom: '65px' }}>
          <div className="px-0 lg:px-8" style={{ maxWidth: '1200px', margin: '0 auto' }}>
            <h2 className="text-4xl font-bold mb-6 text-center font-heading px-4 lg:px-0" style={{ letterSpacing: '-0.02em' }}>
              {t('azienda.values.title')}
            </h2>
            <div style={{ marginBottom: '30px' }} />
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 w-[calc(100%-32px)] lg:w-full max-w-none mx-auto lg:mx-0">
              {[
                {
        ...
        <section className="py-20" style={{ paddingTop: '30px', paddingBottom: '80px' }}>
          <div className="px-0 lg:px-8" style={{ maxWidth: '1400px', margin: '0 auto' }}>
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="w-[calc(100%-32px)] lg:w-full rounded-xl overflow-hidden shadow-2xl mx-auto lg:mx-0 max-w-none"
            >
              <Image
        ...
        <section className="bg-bg-light" style={{ paddingTop: '40.75px', paddingBottom: '40.75px', display: 'flex', alignItems: 'center', minHeight: '200px' }}>
          <div className="px-0 lg:px-8" style={{ maxWidth: '1200px', margin: '0 auto', width: '100%' }}>
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="text-center w-[calc(100%-32px)] lg:w-full max-w-none mx-auto lg:mx-0"
            >
